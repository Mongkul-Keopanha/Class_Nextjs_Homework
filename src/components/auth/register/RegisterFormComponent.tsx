...
export default function RegisterFormComponent() {
  ...
  //* Logic with form here - give to API
  function onSubmit(data: z.infer<typeof formSchema>) {
    // យើងដក confirmPassword ចេញ យកតែ username, email, password ដើម្បីបោះទៅ API
    ...
    const postdata = async () => {
      try {
        ...
        if (res.ok) {
          ...
          // ចាប់ Error ពី Backend ពេល Register មិនបាន (ឧ. Email ជាន់គ្នា)
