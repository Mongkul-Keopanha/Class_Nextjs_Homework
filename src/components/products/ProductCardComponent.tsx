...
export default function EcommerceProductCard({image, title, price, description}: productInter) {
      ...
      <Card className="w-80 rounded-2xl overflow-hidden p-0 gap-0  group/card">
        ...
        <CardContent className="px-4 pt-4 pb-4 space-y-1.5">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <span className="text-foreground font-bold text-base">${price - (price*0.21)}</span>
          </div>
